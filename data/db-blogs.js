const blogs = [
    ...
    },   
    {
        ...
        description: '',
        textbrief: 'A city in the state of Bayern, located southwest of Munich. People want to visit a nearby city and also find activities to do in the Mountains. Then go to Bad Tölz town. Strolling in the city streets. Many Restaurants 🍽, Cafes🍹☕️ and Ice cream🍦. Then take bus 9612 to Blomberg to ride the Cable Car🚠 and go down by the Toboggan.',
        text1: '',
        text2: '',
        text3: '',
        links: '',
