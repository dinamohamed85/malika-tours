const blogs = [
    ...
    }, 
    {
        ...
        description: '',
        textbrief: 'Best places to hang out in Munich and Bayern.',
        text1: '',
        text2: '',
        text3: '',
        links: '',
    ...
    {
        id: '303',
        title: 'Ingolstadtvillage🛍-Outlet',
        category: 'shopping',
        categorylink: 'https://explory24.com/tours.html?category=best',
        icon: 'fa-solid fa-city',
        country: 'Germany',
        ...
        description: '',
        textbrief: 'Outing and Shopping outside of Munich in the  ingolstadt city near Munich (an hour and a half by train).. An open place like a shopping mall, there are many shops for clothes and shoes of brands with much lower prices than Munich stores. And there are restaurants and cafes so that the outing is as you like',
        text1: '',
        text2: '',
        text3: '',
        links: '',
