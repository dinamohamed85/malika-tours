const blogs = [
    ...
    },
    {
        ...
        activities: ['burger'],
        description: '',
        textbrief: 'Try a different taste of a burger "Meat In Bun" Burger restaurant ranked among the top 10 restaurants in Munich, bread burgers is different 9,90€🍔 And you can choose (pommes in a new way or crispy and hot Süßkartoffeln fries🍟with a drink (5,50) and also kidsMenü. and yummy😋Guten Appetit',
        text1: '',
        text2: '',
        text3: '',
        links: '',
