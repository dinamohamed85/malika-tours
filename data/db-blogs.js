const blogs = [
    ...
    },   
    {
        ...
        description: '',
        textbrief: 'A city in the state of Bayern, located southwest of Munich. If you want to visit a nearby city and also find activities to do in the mountains. You have to go to Bad Tölz town by train. We strolling in the city streets. There are Restaurants🍽, Cafes🍹☕️ and Ice cream🍦. Then we take bus 9612 to Blomberg to ride the Cable Car🚠 and go down by the Toboggan.',
        text1: '',
        text2: '',
        text3: '',
        links: '',
