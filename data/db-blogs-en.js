const blogs = [
    ...
    }, 
    {
        ...
        description: '',
        textbrief: '☀️ ☂ When the weather is very hot and sunny, that means we need to swimm🏊 in the water and feel the resort vibs of the summer, and we will also find landscape, playground areas for kids, tennis courts and volley playgrounds, and not far from Munich, we must prepare the beach bag and let`s go to a lake Languider see. Half an hour from Munich by S3 towards Mammendorf we get off station Lochhausen then the lake bus',     
        text1: '',
        text2: '',
        text3: '',
        links: '',
