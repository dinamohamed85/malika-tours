const blogs = [
    ...
    },
    {
        ...
        description: '',
        textbrief: 'You would like to eat Indian food(chicken, rice and salad with Indian sauce) at lunch or dinner for only 9€ 😋. We tried it many times, really the best Indian food in this price, and we always order (chicken masala or chicken tikka), for the kids choose the yellow curry sauce because it is not hot or order the Korma dish. and then we drink mango lassi. If you like Indian food, it is worth to try. find 5 branches and you can also order it delivery.',
